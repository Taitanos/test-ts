...
import {demolishHousesOnTheStreet, getBuildingsWithStaffCountGreaterTen} from "./04_02";
...
test ("Building with correct staff count", () => {
    let buildings = getBuildingsWithStaffCountGreaterTen(city.governmentBuildings, 500)
